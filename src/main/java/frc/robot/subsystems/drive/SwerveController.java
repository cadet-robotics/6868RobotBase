...
public class SwerveController
{
  ...
  {
    thetaController = Robot.isReal() ? SwerveDriveConstants.rotationalPID : SwerveDriveConstants.simRotationalPID;
    lastAngleScalar = 0;
  }
                                          ...
                                          double currentHeadingAngleRadians)
  {
    ...
    return getRawTargetSpeeds(xSpeed, ySpeed,
                              ...
                              SwerveDriveConstants.maxAngularVelocity.magnitude());
  }
  ...
  {
    return thetaController.calculate(currentHeadingAngleRadians, targetHeadingAngleRadians) * SwerveDriveConstants.maxAngularVelocity.magnitude();
  }
}
